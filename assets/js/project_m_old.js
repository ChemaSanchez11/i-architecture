$(document).ready(function () {
    ...
    $('#video-input').on('change', async function () {
        ...
        const response = await fetch(window.base_url + 'api/edit_project', {
            method: 'POST',
            body: formData
        });
    ...
    $("#menu-edit").on("click", async function () {
        if (currentSection) {
            ...
            try {
                ...
                const response = await fetch(window.base_url + 'api/get_section', {
                    method: 'POST',
                    body: formData
                });
    ...
    $("#menu-delete").on("click", async function () {
        if (currentSection) {
            ...
            try {
                const response = await fetch(window.base_url + 'api/delete_section', {
                    method: 'POST',
                    body: formData
                });
...
// botoncitos
    ...
    $('#demo-new-section').click(async function () {
        ...
        try {
            const response = await fetch(window.base_url + 'api/generate_section_demo', {
                method: 'POST',
                body: formData
            });
    ...
    $('#create-new-section').click(async function () {
        ...
        try {
            const response = await fetch(window.base_url + 'api/new_section', {
                method: 'POST',
                body: formData
            });
    ...
    $(function () {
        ...
        $('#move-up').on('click', async function () {
            ...
            if ($prev.length) {
                ...
                let input = window.base_url + 'api/move_section';
